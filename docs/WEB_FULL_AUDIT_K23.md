...
| `pnpm exec vitest run --maxWorkers=1` | **PASS** | 29 file, **174/174** test sau chuẩn hóa category, nhánh chuyên ngành và tổng tín chỉ K23. |
...
- `pnpm exec vitest run --maxWorkers=1`: PASS **29/29 file và 174/174 test**; extension production `0.2.8` và web build PASS. Typecheck toàn repository còn lỗi ngoài phạm vi K23.
