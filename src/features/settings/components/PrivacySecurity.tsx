...
const sections = [
    {
        ...
        content: 'UStudy được thiết kế với nguyên tắc "Privacy by Design". Dữ liệu học tập chính được mã hóa và lưu trên thiết bị. Trên APK Android, sau khi bạn mở khóa và có thời khóa biểu, bản lịch rút gọn được lưu riêng trong ứng dụng, không mã hóa, để widget có thể hiển thị ngay cả khi UStudy đang khóa.'
    },
    // {
    //     id: 'encryption',
    //     icon: Lock,
    ...
    // },
    {
        ...
        items: [
            { icon: Globe, label: 'Dữ liệu học tập trên thiết bị', desc: 'Dữ liệu chính lưu trong localStorage của UStudy. Trên APK Android, tên môn, giờ và phòng của lịch 30 ngày tới còn được lưu trong vùng riêng của ứng dụng để sẵn cho widget; xóa toàn bộ dữ liệu UStudy sẽ xóa cả bản này. Không gửi bản lịch lên server.' },
...
export function PrivacySecurity() {
    return (
        <PageShell
            header={<PageHeader
                title="Bảo mật & Quyền dữ liệu cá nhân"
                description="Tìm hiểu cách UStudy bảo vệ dữ liệu của bạn và các quyền bạn có đối với thông tin cá nhân."
            />}
        >
